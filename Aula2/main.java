...
public class main{
    public static void main(String [] args){
        ...
        switch(escolha){
            case 2: 
                int [][] z = new int [5][5];
                System.out.println("A Iniciar a Leitura da Pauta ...");
                pautaex.ler_pauta(z);
                System.out.println("A Printar Pauta");
                pautaex.printar_pauta(z);
                System.out.println("----->  A soma das notas da UC é" +" " + pautaex.somar(z,3));
                System.out.println("----->  Média do aluno" + " " + pautaex.media_aluno(z,2));
                System.out.println("----->  Média da UC" + " " + pautaex.media_uc(z,2));
